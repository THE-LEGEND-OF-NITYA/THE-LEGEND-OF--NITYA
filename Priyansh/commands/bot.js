...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "👍") || (event.body.toLowerCase() == "👍🏻")) {
     return api.sendMessage("𝐀𝐑𝐄𝐇 𝐀𝐃𝐈 𝐌𝐀𝐍𝐀𝐕 𝐙𝐎𝐎 𝐒𝐄 𝐁𝐀𝐇𝐑 𝐊𝐀𝐈𝐒𝐄 𝐀𝐆𝐀𝐘𝐀 𝐓𝐔. 𝐅𝐈𝐑 𝐒𝐄 𝐙𝐎𝐎 𝐌 𝐉𝐀. 𝐁𝐀𝐇𝐀𝐑 𝐊𝐘À 𝐊𝐀𝐑 𝐑𝐇𝐀 𝐇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {return api.sendMessage("𝐎𝐊 𝐁𝐘𝐄 𝐉𝐀𝐋𝐃𝐈 𝐏𝐇𝐈𝐑 𝐒𝐄 𝐌𝐈𝐋𝐄𝐆𝐄 🙄", threadID);
   };

  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
     return api.sendMessage("️ 𝐊𝐘𝐀 𝐈𝐁 𝐈𝐁 👿 𝐈𝐃𝐇𝐀𝐑 𝐁𝐎𝐋 𝐌𝐄𝐑3 𝐒𝐀𝐌𝐍𝐘 ", threadID);
   };
...
if ((event.body.toLowerCase() == ".") || (event.body.toLowerCase() == "..")) {
   ...
   if ((event.body.toLowerCase() == "tharki bot") || (event.body.toLowerCase() == "bot tharki")) {
     return api.sendMessage("𝐓𝐔 𝐓𝐇𝐀𝐑𝐊𝐈 𝐓𝐑𝐀  𝐁𝐀𝐏 𝐓𝐇𝐀𝐑𝐊𝐈 𝐓𝐄𝐑𝐀 𝐃𝐀𝐃𝐀 𝐓𝐇𝐀𝐑𝐊𝐈 🤬🤗", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bhenchod")) {
     return api.sendMessage("𝐓𝐔 𝐇𝐀𝐈 𝐁𝐂 𝐌𝐂 🙂 𝐌𝐀𝐈𝐍 𝐓𝐎𝐎 𝐁𝐎𝐓 𝐇𝐔𝐍 😂😂😂 ", threadID);
   };

   if ((event.body.toLowerCase() == "ja rha") || (event.body.toLowerCase() == "ja rhi")) {
     return api.sendMessage("𝐀𝐑𝐄 𝐓𝐔 𝐉𝐀 𝐍𝐀 𝐑𝐄𝐄 ", threadID);
   };

   if ((event.body.toLowerCase() == "nikal") || (event.body.toLowerCase() == "nikl")) {
     return api.sendMessage("𝐂𝐇𝐀𝐋 𝐂𝐇𝐀𝐋 𝐓𝐔 𝐍𝐈𝐊𝐀𝐋", threadID);
   };

   if ((event.body.toLowerCase() == "jan") || (event.body.toLowerCase() == "janu")) {
     return api.sendMessage("𝐀𝐖𝐖🥰 𝐘𝐄𝐒 𝐌𝐘 𝐋𝐎𝐕𝐄", threadID);
   };

if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
     return api.sendMessage("𝐒𝐇𝐀𝐑𝐀𝐅𝐓 𝐒𝐘 𝐌𝐔𝐒𝐊𝐔𝐑𝐀 𝐑𝐇𝐀 𝐇𝐘 😂", threadID);
   };
   ...
   if ((event.body.toLowerCase() = = "😂") || (event.body.toLowerCase() == "😂😂")) {
     return api.sendMessage("𝐉𝐀𝐍𝐔 𝐌𝐔𝐒𝐊𝐔𝐑𝐀 𝐓𝐄  𝐑𝐀𝐇𝐎 𝐀S𝐘 💞😘 ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😘😘")) {
     return api.sendMessage("𝐒𝐀𝐑𝐀𝐌 𝐊𝐑𝐋𝐎 𝐘𝐄 𝐂𝐇𝐔𝐌𝐌𝐀 𝐂𝐇𝐀𝐓𝐈 𝐂𝐇𝐎𝐑𝐎 𝐏𝐀𝐃𝐇𝐀𝐈 𝐏𝐄 𝐃𝐇𝐈𝐘𝐀𝐍 𝐃𝐎😒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Good night") || (event.body.toLowerCase() == "GOOD NIGHT")) {
     return api.sendMessage("𝐆𝐎𝐎𝐃 𝐍𝐈𝐆𝐇𝐓 𝐌𝐄𝐑𝐈 𝐉𝐀𝐀𝐍 𝐒𝐖𝐄𝐄𝐓 𝐃𝐑𝐈𝐌𝐒 𝐀𝐍𝐃 𝐌𝐈𝐒𝐒 𝐘𝐎𝐔 𝐒𝐎 𝐌𝐔𝐂𝐇 𝐉𝐀𝐍𝐔 😘🥰", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥳") || (event.body.toLowerCase() == "🥳🥳")) {
     return api.sendMessage("𝐌𝐄𝐑𝐈 𝐓𝐄𝐑𝐀 𝐇𝐀𝐏𝐏𝐘 𝐁𝐈𝐑𝐓𝐇𝐃𝐀𝐘 ", threadID);
   };


   if ((event.body.toLowerCase() == "🙃") || (event.body.toLowerCase() == "🙃🙃")) {
     return api.sendMessage("𝐇𝐀𝐘𝐄 𝐑𝐀𝐁𝐁À ☹️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥲") || (event.body.toLowerCase() == "🥲🥲")) {
     return api.sendMessage("𝐀𝐒𝐄 𝐌𝐔𝐔 𝐁𝐀𝐍𝐀 𝐊𝐑 𝐌𝐓 𝐑𝐎𝐎 😒", threadID);
   };

   if ((event.body.toLowerCase() == "😊") || (event.body.toLowerCase() == "😊😊")) {
     return api.sendMessage("𝐒𝐔𝐊𝐀𝐑 𝐇𝐀𝐈 𝐒𝐌𝐈𝐋𝐄 𝐓𝐎 𝐊𝐈 🥺", threadID);
   };

   if ((event.body.toLowerCase( == "☺️") || (event.body.toLowerCase() == "☺️☺️")) {
     return api.sendMessage("𝐘𝐄 𝐒𝐌𝐈𝐋𝐄 𝐍𝐀 𝐃𝐎𝐎 𝐍𝐎𝐖🥺", threadID);
   };

   if ((event.body.toLowerCase() == "😌") || (event.body.toLowerCase() == "😌😌")) {
     return api.sendMessage("𝐇𝐄 𝐘𝐄 𝐌𝐀𝐒𝐎𝐎𝐌", threadID);
   };

   if ((event.body.toLowerCase() == "😏") || (event.body.toLowerCase() == "😏😏")) {
     return api.sendMessage("𝐂𝐇𝐀𝐋 𝐇𝐀𝐓 𝐌𝐑𝐄 𝐒𝐀𝐌𝐍𝐄 𝐌𝐓 𝐈𝐓𝐑𝐀 𝐓𝐄𝐑𝐀 𝐌𝐔𝐔 𝐋𝐄 𝐊𝐄𝐑 😂", threadID);
   };

   if ((event.body.toLowerCase() == "😴") || (event.body.toLowerCase() == "😴😴")) {
     return api.sendMessage("𝐂𝐇𝐀𝐋 𝐉𝐀 𝐍𝐀𝐇𝐀 𝐊𝐀𝐑 𝐀𝐀", threadID);
   };

   if ((event.body.toLowerCase() == "😪") || (event.body.toLowerCase() == "😪😪")) {
     return api.sendMessage("𝐀𝐁𝐘 𝐓𝐄𝐑𝐈 𝐍𝐎𝐒𝐄 𝐍𝐈𝐊𝐀𝐋 𝐑𝐇𝐈 😂", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😝") || (event.body.toLowerCase() == "😝😝")) {
     return api.sendMessage("𝐀𝐁𝐘 𝐀𝐍𝐊𝐇 𝐊𝐇𝐎𝐋 𝐎𝐎𝐑 𝐙𝐔𝐁𝐀𝐍 𝐀𝐍𝐃𝐀𝐑 𝐊𝐀𝐑 𝐖𝐀𝐑𝐍𝐀 𝐊𝐀𝐓 𝐃𝐔𝐍𝐆𝐀", threadID);
   };

   if ((event.body.toLowerCase() == "😜") || (event.body.toLowerCase() == "😜😜")) {
     return api.sendMessage("𝐁𝐀𝐑𝐈 𝐌𝐀𝐒𝐓𝐈 𝐂𝐇𝐀𝐑𝐈 𝐇𝐀𝐈 𝐓𝐄𝐑𝐄𝐊𝐎 1 𝐀𝐍𝐊𝐇 𝐁𝐀𝐍𝐃 𝐊𝐀𝐑  𝐙𝐔𝐁𝐀𝐍 𝐁𝐇𝐈𝐑 𝐀𝐀𝐆𝐘𝐈 😂😂😂", threadID);
   };

   if ((event.body.toLowerCase() == "🤪") || (event.body.toLowerCase() == "🤪🤪")) {
     return api.sendMessage("𝐘𝐄 𝐀𝐉𝐄𝐄𝐁_𝐎_𝐆𝐀𝐑𝐄𝐄𝐁 𝐌𝐔𝐔 𝐍𝐀 𝐁𝐀𝐍𝐀 😂 𝐂𝐀𝐑𝐓𝐎𝐎𝐍 🤣", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥺") || (event.body.toLowerCase() == "🥺🥺")) {
     return api.sendMessage("𝐓𝐀 𝐇𝐔𝐖𝐀 𝐌𝐘 𝐋𝐎𝐕𝐄 🥺", threadID);
   };

   if ((event.body.toLowerCase() == "😬") || (event.body.toLowerCase() == "😬😬")) {
     return api.sendMessage("𝐊𝐈𝐒 𝐊𝐈 𝐁𝐀𝐉𝐀 𝐃𝐈 🤨🧐", threadID);
   };

   if ((event.body.toLowerCase() == "😑") || (event.body.toLowerCase() == "😑😑")) {
     return api.sendMessage("𝐖𝐀𝐇 𝐌𝐔𝐔 𝐊𝐄 S𝐀𝐓𝐇 𝐀𝐍𝐊𝐇𝐄 𝐁𝐄 𝐁𝐀𝐍𝐃 𝐇𝐎 𝐆𝐘𝐈 😂", threadID);
   };

   if ((event.body.toLowerCase() == "😐") || (event.body.toLowerCase() == "😐😐")) {
     return api.sendMessage("𝐀𝐁 𝐁𝐎𝐎𝐋 𝐍À 😂😂😂", threadID);
   };

   if ((event.body.toLowerCase() == "😶") || (event.body.toLowerCase() == "😶😶")) {
     return api.sendMessage("𝐍𝐀𝐊 𝐓𝐎 𝐓𝐇𝐈 𝐍𝐇𝐈 𝐌𝐔𝐇 𝐁𝐄 𝐆𝐘𝐁 𝐇𝐎𝐎 𝐆𝐀𝐘𝐀 𝐓𝐄𝐑𝐀 😂😂😂", threadID);
   };

   if ((event.body.toLowerCase() == "🤐") || (event.body.toLowerCase() == "🤐🤐")) {
     return api.sendMessage("𝐀𝐁 𝐓𝐑𝐈 𝐀𝐖𝐀𝐙 𝐀𝐈 𝐍𝐀 𝐓𝐎 𝐌𝐄 𝐀𝐋𝐅𝐈 𝐒𝐘 𝐁𝐀𝐍𝐃 𝐊𝐑𝐔𝐍𝐆𝐀 😒", threadID);
   };

   if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤔🤔")) {
     return api.sendMessage("𝐊𝐘𝐀 𝐒𝐎𝐂𝐇 𝐑𝐇𝐘 🤔", threadID);
   };

   if ((event.body.toLowerCase() == "🤫") || (event.body.toLowerCase() == "🤫🤫")) {
     return api.sendMessage("𝐓𝐑𝐈 𝐘𝐄𝐇 𝐔𝐍𝐆𝐋𝐈 𝐓𝐑𝐈 𝐇𝐈 𝐍𝐀𝐊 𝐌𝐄 𝐃𝐀𝐋𝐃𝐔𝐍𝐆𝐀 𝐌𝐀𝐈 😒😂", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥱") || (event.body.toLowerCase() == "🥱")) {
     return api.sendMessage("𝐀𝐉𝐀 𝐁𝐀𝐁𝐄 𝐌𝐄𝐋𝐘 𝐏𝐀𝐒 𝐒𝐎𝐎 𝐉𝐀𝐀😜", threadID);
   };

   if ((event.body.toLowerCase() == "🤗") || (event.body.toLowerCase() == "🤗🤗")) {
     return api.sendMessage("𝐏𝐇𝐋𝐄 𝐍𝐀𝐇𝐀 𝐊𝐑 𝐀𝐀 😂", threadID);
   };

   if ((event.body.toLowerCase() == "😱") || (event.body.toLowerCase() == "😱😱")) {
     return api.sendMessage("𝐊𝐘𝐀 𝐇𝐔𝐖𝐀 😱 𝐒𝐇𝐈𝐒𝐇𝐀 𝐃𝐄𝐊𝐇 𝐋𝐈𝐘𝐀 𝐊𝐘𝐀 😳", threadID);
   };

   if ((event.body.toLowerCase() == "🤨") || (event.body.toLowerCase() == "🤨🤨")) {
     return api.sendMessage("𝐓𝐔 𝐇𝐔SS𝐇𝐈𝐘𝐀𝐑 𝐁𝐀𝐍 𝐊𝐀𝐑 𝐍𝐀 𝐃𝐄𝐊𝐇 𝐌𝐀𝐈𝐍 𝐇𝐔𝐍 𝐍𝐎𝐖 😂", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒😒")) {
     return api.sendMessage("𝐓𝐄𝐑𝐈 𝐓𝐎𝐅𝐅𝐈 𝐋𝐄𝐋𝐈 𝐊𝐈S𝐈 𝐍𝐘 𝐉𝐎𝐎 𝐀𝐈𝐒𝐀 𝐌𝐔𝐔 𝐁𝐀𝐍𝐀 𝐋𝐈𝐘𝐀 😂", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😤") || (event.body.toLowerCase() == "😤😤")) {
     return api.sendMessage("𝐘𝐄 𝐁𝐔𝐋𝐋🐂 𝐉𝐄𝐒𝐀 𝐌𝐔𝐇 𝐍𝐀 𝐁𝐀𝐍𝐀 😂", threadID);
   };

   if ((event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "😠😠")) {
     return api.sendMessage("𝐁𝐀𝐁𝐄 𝐆𝐔𝐒𝐒𝐀 𝐍𝐀𝐇𝐈 𝐊𝐑𝐓𝐘 𝐘𝐄 𝐋𝐎𝐎 𝐔𝐌𝐔𝐀𝐀𝐇𝐇𝐇 😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "🤬🤬")) {
     return api.sendMessage("𝐀𝐖𝐖 😐", threadID);
   };

   if ((event.body.toLowerCase() == "😞") || (event.body.toLowerCase() == "😞😞")) {
     return api.sendMessage("𝐀𝐖𝐖 𝐓𝐀 𝐇𝐔𝐖𝐀 𝐁𝐀𝐁𝐄", threadID);
   };
     ...
     return api.sendMessage("𝐓𝐀 𝐇𝐔𝐖𝐀 𝐌𝐘 𝐋𝐎𝐕𝐄 🥺", threadID);
      ...
      if ((event.body.toLowerCase() == "☹️") || (event.body.toLowerCase() == "☹️☹️")) {
     return api.sendMessage("𝐀𝐖𝐖𝐖 🥺", threadID);
   };

      if ((event.body.toLowerCase() == "🙁") || (event.body.toLowerCase() == "🙁🙁")) {
     return api.sendMessage("𝐀𝐖𝐖 ☹️", threadID);
   };
     ...
     return api.sendMessage("😧", threadID);
      ...
      if ((event.body.toLowerCase() == "😮") || (event.body.toLowerCase() == "😮😮")) {
     return api.sendMessage("𝐀𝐁𝐘 𝐌𝐔𝐔 𝐁𝐀𝐌𝐃 𝐊𝐑𝐑 𝐌𝐀𝐂𝐇𝐀𝐑 𝐆𝐔𝐒 𝐉𝐀𝐘𝐆𝐀 𝐌𝐔𝐔 𝐌𝐀𝐈 😂😂😂", threadID);
   };
     ...
     return api.sendMessage("😯", threadID);
      ...
      if ((event.body.toLowerCase() == "😳") || (event.body.toLowerCase() == "😳😳")) {
     return api.sendMessage("𝐀𝐁𝐘 𝐁𝐇𝐄𝐍𝐒 𝐂𝐇𝐎𝐑 𝐊𝐘𝐀 𝐆𝐘𝐀 😳😳😳", threadID);
   };

      if ((event.body.toLowerCase() == "🤯") || (event.body.toLowerCase() == "🤯🤯")) {
     return api.sendMessage("𝐓𝐑𝐄 𝐒𝐀𝐑 𝐌𝐄 𝐁𝐔𝐌𝐁 𝐊𝐈𝐒 𝐍𝐘 𝐏𝐇𝐎𝐑𝐀 😂", threadID);
   };

      if ((event.body.toLowerCase() == "😖") || (event.body.toLowerCase() == "😖😖")) {
     return api.sendMessage("𝐀𝐒𝐀 𝐌𝐔𝐔 𝐍𝐀 𝐁𝐀𝐍𝐀 😂", threadID);
   };
     ...
     return api.sendMessage("😣😣😣", threadID);
      ...
      if ((event.body.toLowerCase() == "😩") || (event.body.toLowerCase() == "😫")) {
     return api.sendMessage("𝐂𝐇𝐀𝐋 𝐇𝐀𝐓 𝐍𝐎𝐓𝐀𝐍𝐆𝐈 😫😂😂", threadID);
   };

      if ((event.body.toLowerCase() == "😵") || (event.body.toLowerCase() == "😵😵")) {
     return api.sendMessage("𝐀𝐒𝐀 𝐊𝐘𝐀 𝐃𝐄𝐊𝐇 𝐋𝐈𝐘𝐀 😳", threadID);
   };

      if ((event.body.toLowerCase() == "🥶") || (event.body.toLowerCase() == "sardi")) {
     return api.sendMessage("𝐀𝐖𝐖 𝐁𝐀𝐁𝐄  𝐒𝐀𝐑𝐃𝐈 𝐋𝐀𝐆 𝐑𝐇𝐈 𝐓𝐎𝐎 𝐌𝐑𝐄 𝐏𝐀𝐒𝐒 𝐀𝐉𝐀𝐎 🙈😜", threadID);
   };

      if ((event.body.toLowerCase() == "🥵") || (event.body.toLowerCase() == "🥵🥵")) {
     return api.sendMessage("𝐍𝐀𝐇𝐀 𝐋𝐄 😂🥶", threadID);
   };

      if ((event.body.toLowerCase() == "🤢") || (event.body.toLowerCase() == "🤮")) {
     return api.sendMessage("𝐊𝐀𝐔𝐍𝐒𝐀 𝐌𝐎𝐍𝐓𝐇 𝐂𝐇𝐀𝐋 𝐑𝐀𝐇𝐀 𝐇𝐀𝐈", threadID);
   };

      if ((event.body.toLowerCase() == "🤧") || (event.body.toLowerCase() == "😷")) {
     return api.sendMessage("𝐀𝐑𝐄  𝐉𝐀 𝐍𝐀 𝐌𝐄𝐊𝐎 𝐁𝐄 𝐁𝐄𝐌𝐀𝐑 𝐊𝐀𝐑𝐍𝐀 𝐊𝐘𝐀 🥺", threadID);
   };

      if ((event.body.toLowerCase() == "🤒") || (event.body.toLowerCase() == "🤕")) {
     return api.sendMessage("𝐀𝐖𝐖 𝐁𝐀𝐁𝐄 𝐊𝐎𝐎 𝐓𝐀 𝐓𝐀𝐇𝐔𝐀 𝐈𝐃𝐇𝐀𝐑 𝐀𝐎𝐖 𝐓𝐇𝐎𝐑𝐀 𝐏𝐀𝐘𝐋 𝐋𝐎𝐎 😜💉💉💉", threadID);
   };

      if ((event.body.toLowerCase() == "😎") || (event.body.toLowerCase() == "😎😎")) {
     return api.sendMessage("𝐒𝐇𝐎𝐊𝐈𝐍 𝐍𝐀 𝐌𝐀𝐑 😂 𝐆𝐇𝐑 𝐌𝐄 𝐃𝐔S𝐑𝐈 𝐁𝐀𝐑 𝐑𝐎𝐓𝐈 𝐍𝐇𝐈 𝐌𝐈𝐋𝐓𝐈 𝐔𝐇 𝐊𝐎𝐎 😂😂😂", threadID);
   };
     ...
     return api.sendMessage("😇😇😇", threadID);
      ...
      if ((event.body.toLowerCase() == "🥸") || (event.body.toLowerCase() == "🤓")) {
     return api.sendMessage("𝐀𝐍𝐊𝐇 𝐖𝐀𝐋𝐀 𝐉𝐈𝐍 😂", threadID);
   };

      if ((event.body.toLowerCase() == "🤡") || (event.body.toLowerCase() == "🤡🤡")) {
     return api.sendMessage("𝐀𝐖𝐖 𝐒𝐎𝐎 𝐒𝐖𝐄𝐄𝐓 😂 CarT0on", threadID);
   };
     ...
     return api.sendMessage("👽👽👽", threadID);
      ...
      if ((event.body.toLowerCase() == "😹") || (event.body.toLowerCase() == "😹😹")) {
     return api.sendMessage("𝐀𝐁𝐘 𝐘𝐀𝐋 𝐁𝐈𝐋𝐋𝐈 𝐉𝐘𝐒𝐄 𝐌𝐔𝐔 𝐒𝐘 𝐍𝐀 𝐇𝐀𝐒𝐇 😂", threadID);
   };
     ...
     return api.sendMessage("😼😼😼", threadID);
      ...
      if ((event.body.toLowerCase() == "😼") || (event.body.toLowerCase() == "😼😼")) {
     return api.sendMessage("𝐓𝐄𝐑𝐘S𝐄 𝐀𝐗𝐇𝐀 𝐓𝐎𝐎 𝐁𝐈𝐋𝐋𝐈 𝐈𝐓𝐑𝐀 𝐋𝐄𝐓𝐈 😂", threadID);
   };

      if ((event.body.toLowerCase() == "💋") || (event.body.toLowerCase() == "💋💋💋")) {
     return api.sendMessage("𝐘𝐀𝐇 𝐏𝐀𝐏𝐏𝐈 𝐂𝐇𝐀𝐏𝐈 𝐍𝐇𝐈 𝐊𝐑 𝐌𝐔𝐉𝐄 𝐆𝐇𝐈𝐍 𝐀𝐓𝐈 𝐇𝐀𝐈  😂😂😂", threadID);
   };
     ...
     return api.sendMessage("❤️🧡💛💚💙💜🤎", threadID);
      ...
      if ((event.body.toLowerCase() == "👻") || (event.body.toLowerCase() == "👻👻")) {
     return api.sendMessage("𝐀𝐑𝐈 𝐌𝐎𝐑𝐈 𝐌𝐀𝐈𝐘𝐀 𝐄 𝐊𝐀 𝐃𝐄𝐊𝐇 𝐋𝐈𝐘𝐎👻💀", threadID);
   };

      if ((event.body.toLowerCase() == "🖕") || (event.body.toLowerCase() == "🖕🖕")) {
     return api.sendMessage("𝐆𝐀𝐍𝐃 𝐌𝐄  𝐋𝐄𝐋𝐄 𝐀𝐏𝐍𝐈 𝐁𝐇𝐄𝐍𝐒 𝐂𝐇𝐎𝐑 😂😂😂", threadID);
   };

      if ((event.body.toLowerCase() == "💉") || (event.body.toLowerCase() == "💊")) {
     return api.sendMessage("𝐔𝐇 𝐊𝐎𝐎 𝐊𝐇𝐔𝐃 𝐊𝐎 𝐈𝐒𝐊𝐈 𝐙𝐀𝐈𝐃𝐀 𝐙𝐀𝐑𝐔𝐑𝐀𝐓 𝐇𝐀𝐈 🤣", threadID);
   };

      if ((event.body.toLowerCase() == "🙈") || (event.body.toLowerCase() == "🙊")) {
     return api.sendMessage("𝐔𝐅𝐅 𝐌𝐄𝐑𝐄 𝐒𝐄 𝐈𝐓𝐍𝐀 𝐒𝐀𝐑𝐀𝐌 𝐁𝐎𝐓 𝐇𝐔𝐍 𝐓𝐄𝐑𝐀 𝐒𝐀𝐒𝐔𝐑 𝐍𝐀𝐇𝐈 😂", threadID);
   };

      if ((event.body.toLowerCase() == "Chutia") || (event.body.toLowerCase() == "chutiya")) {
     return api.sendMessage("𝐓𝐔 𝐇𝐀𝐈 𝐂𝐇𝐔𝐓𝐈𝐘𝐀 🙂 𝐌𝐀𝐈𝐍 𝐓𝐎𝐎 𝐁𝐎𝐓 𝐇𝐔𝐍 𝐍𝐎𝐖🥺😂", threadID);
   };

      if ((event.body.toLowerCase() == "oye") || (event.body.toLowerCase() == "oyee")) {
     return api.sendMessage("𝐎𝐘𝐄 𝐇𝐎𝐘𝐄 😈", threadID);
   };

   if ((event.body.toLowerCase() == "Ok") || (event.body.toLowerCase() == "Okay")) {
     return api.sendMessage("𝐊𝐘𝐀 𝐎𝐊🙄 Haan", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "huh") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("𝐊𝐘𝐀 𝐇𝐌𝐌 🙄𝐓𝐇𝐀𝐑𝐊𝐈", threadID);
   };

   if ((event.body.toLowerCase() == "acha") || (event.body.toLowerCase() == "acha g")) {
     return api.sendMessage("𝐇𝐀𝐍 𝐉𝐈 🙄 𝐉𝐀𝐀𝐍", threadID);
   };

   if ((event.body.toLowerCase() == "Janu") || (event.body.toLowerCase() == "jan")) {
     return api.sendMessage("𝐁𝐎𝐋𝐎 𝐍𝐀𝐀 𝐌𝐄𝐑𝐈 𝐉𝐀𝐀𝐍🥰💙", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Good morning") || (event.body.toLowerCase() == "good morning Darling")) {
     return api.sendMessage("𝐇𝐄𝐋𝐋𝐎 𝐃𝐄𝐀𝐑, 𝐇𝐀𝐕𝐄 𝐀 𝐍𝐈𝐂𝐄 𝐃𝐀𝐘 ❤️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
   ...
   if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
     return api.sendMessage("𝐒𝐑𝐑𝐘 𝐌𝐀𝐋𝐈𝐊 𝐌𝐀𝐀𝐅 𝐊𝐑 𝐃𝐎 𝐀𝐁 𝐍𝐀𝐇𝐈 𝐊𝐑𝐔𝐍𝐆𝐀 🥺🙏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️𝐇𝐌𝐌 𝐇𝐌𝐌 𝐍𝐀 𝐊𝐑 𝐒𝐈𝐃𝐇𝐀 𝐒𝐈𝐃𝐇𝐀 𝐁𝐎𝐋𝐎. 𝐇𝐀𝐘 𝐌𝐑𝐑𝐘 𝐌𝐄🙈", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage("𝐓𝐇𝐎𝐃𝐀 𝐊𝐀𝐌 𝐇𝐀𝐒 𝐖𝐀𝐑𝐍𝐀 𝐄𝐊 𝐌𝐔𝐊𝐊𝐄 𝐌𝐄 𝐒𝐀𝐑𝐄 𝐃𝐀𝐍𝐓 𝐓𝐎𝐃 𝐃𝐔𝐍𝐆𝐀 😈🙄🤐", threadID);
   };

   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("𝐀𝐍𝐊𝐇𝐎 𝐌 𝐏𝐘𝐀𝐑, 𝐃𝐈𝐋 𝐌𝐄 𝐊𝐇𝐀𝐑, 𝐏𝐀𝐘𝐑 𝐓𝐇𝐎 𝐍𝐇𝐈 𝐊𝐑 𝐋𝐈𝐘𝐀 𝐌𝐔𝐉𝐇𝐒𝐄🥰", threadID);
   };

   if ((event.body.toLowerCase() == "kese ho") || (event.body.toLowerCase() == "kaise ho") || (event.body.toLowerCase() == "kese ho ji") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
     return api.sendMessage("𝐌 𝐓𝐀𝐁𝐇𝐈 𝐀𝐂𝐂𝐇𝐀 𝐇𝐎𝐓𝐀 𝐇𝐔𝐌, 𝐉𝐀𝐁 𝐀𝐏𝐊𝐎 𝐇𝐀𝐒𝐀𝐓𝐀  𝐇𝐔𝐍 ☺️", threadID);
   };
